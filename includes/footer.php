<footer>
    <div class="container footer-grid">
        <div class="footer-about">
            ...
            <p style="margin-top: 15px;"><i class="fa-regular fa-clock" style="color: var(--accent);"></i> <strong>Jam Operasional:</strong><br>Setiap Hari: 10.00 - 17.00 WIB</p>
        </div>
        ...
        <div class="footer-contact">
            ...
            <p><i class="fa-solid fa-phone" style="color: var(--accent);"></i> 08973648183</p>
            <p><i class="fa-solid fa-envelope" style="color: var(--accent);"></i> @ayampenyetalbarokah.com</p>
        </div>
    </div>
        ...
        <div class="container" style="position: relative;">
            ...
            <?php if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin'): ?>
               ...
               "
                    ...
                    onmouseout="this.style.opacity='0.25'; this.style.transform='scale(1)';"></a>
            <?php endif; ?>
        </div>
    </div>
</footer>
